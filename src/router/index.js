...
export const constantRoutes = [
  ...
  /* 新增 首页 可视化图标 */
  {
    ...
    children: [{
      ...
      meta: {title: '首页', icon: 'shouye', hiddenType: [1]}
    }]
  },
  {
    path: '/userHome',
    ...
    children: [{
      ...
      name: 'userHome',
      component: () => import('@/views/dashboard/index'),
      meta: {title: '首页', icon: 'shouye', hiddenType: [0]}
    }]
  },
  {
    path: '/task',
    ...
    children: [
      {
        ...
        meta: {title: '首页', icon: 'shouye', hiddenType: [3]}
      }
    ]
  },
  {
  ...
  },
  {
    path: '/supportStaff',
    component: Layout,
    meta: {title: '客服管理', icon: '', hiddenType: [-1]},
    children: [
      {
        path: 'supportStaff',
        name: 'supportStaff',
        component: () => import('@/views/supportStaff/index'),
        meta: {title: '客服管理', icon: 'user', hiddenType: [-1]}
      }
    ]
  },
  {
    ...
    children: [
      {
        ...
        meta: {title: '在线聊天', icon: 'user', hiddenType: [4]}
      }
    ]
  },
/*   {
  ...
  },
  {
    path: '/affiche',
    component: Layout,
    meta: {title: '公告配置', icon: 'affiche', hiddenType: [1]},
    children: [
      {
        path: 'index',
        name: 'affiche',
